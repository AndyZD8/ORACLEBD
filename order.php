...
<div id="main">
   ...
   <div class="contact_section layout_padding">
      <div class="container">
         <h1 class="contact_text"><strong>Acá puedes realizar tu Orden</strong></h1>
      </div>
                       ...
                       <div class="container">
                          <form action="contact.php" method="post">
                            <div class="form-group">
                              <input type="text" class="email-bt" placeholder="Ingrese el Código de Producto" name="codigo" style="width: 50%">
                            </div>
                            <div class="form-group">
                              <input type="number" class="email-bt" placeholder="Ingrese la cantidad" name="cantidad" style="width: 50%">
                            </div>
                            <!--
                            <div class="form-group">
                              <input type="text" class="email-bt" placeholder="Número de teléfono" name="Telephone">
                            </div>
                            
                            <div class="form-group">
                                <textarea class="massage-bt" placeholder="Comentarios adicionales" rows="5" id="comment" name="Message" style="width: 50%"></textarea>
                            </div>
                            -->
                            <div class="send_btn">
