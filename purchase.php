...
<div id="main">
   ...
   <!-- Purchase section start -->
         <div class="card">
            <img src="images/Producto1.png" alt="Denim Jeans" style="width:100%">
               <h1>Serum para pestañas 🍃</h1>
                  <p class="price">₡4.000</p>
                  <p>Potenciador del crecimiento de las pestañas y cejas. No irrita, ni contiene olor.</p>
                  <p>Código del producto: 25</p>
                  <form action="order.php">
                  <button type="submit">Me Interesa!</button>
                  </form>
         </div><br>
         <div class="card">
            <img src="images/Producto3.png" alt="Denim Jeans" style="width:100%">
               <h1>Jabones 🙌🏽</h1>
                  <p class="price">₡2.000</p>
                  <p>Cuida tu piel con jabones suaves y frescos 🍃🙌🏽.</p>
                  <p>Código del producto: 77</p>
                  <form action="order.php">
                  <button type="submit">Me Interesa!</button>
                  </form>
         </div>
         ...
         <div class="card">
            <img src="images/Producto6.png" alt="Denim Jeans" style="width:100%">
               <h1>Pulseras para mamá 🥰</h1>
                  <p class="price">₡5.000</p>
                  <p>Un detalle que a mamá le encantará.</p>
                  <p>Código del producto: 45</p>
                  <form action="order.php">
                  <button type="submit">Me Interesa!</button>
                  </form>
         </div>
