...
<div id="main">
   ...
   <div class="our_section layout_padding">
      <div class="container">
         <div class="row">
            <div class="col-sm-12">
               <h1 class="our_text"><strong>Nuestros <span style="color: #000;">Productos</span></strong></h1>
               <p class="about_lorem">Utilizamos productos naturales, sin químicos, sin parabenos.<br>
               Hacemos envíos por correos de Costa Rica y contamos con servicio de mensajería en Palmichal, Tabarcia, Cuidad Colón, Puriscal, Santa Ana y Escazú.</p>
            </div>
         </div>
      </div>
         ...
         <div class="our_main">
            <div id="my_slider" class="carousel slide" data-ride="carousel">
               ...
               <div class="carousel-item active">
                  <img class="d-block mx-auto" src="images/Producto2.png" alt="First slide">
               </div>
               <div class="carousel-item">
                  <img class="d-block mx-auto" src="images/Producto4.png" alt="Second slide">
               </div>
               <div class="carousel-item">
                 <img class="d-block mx-auto" src="images/Producto5.png" alt="Third slide">
               </div>
            </div>
          ...
          <button class="seemore_bt">Más Información</button>
         </form>
      </div>
   </div>
